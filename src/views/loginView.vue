<template>
    <main>
        <div>
            <div class="container">
                <div class="row">
                    <div class="col-md-6" id="alexbizer">
                        <h1>Student Psychology Service(SPS)</h1>
                        <p style="color:white;">Silahkan Login</p>
                    </div>
                    <div class="col-md-6" id="panel">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h6>Email</h6><input type="email">
                                <h6>Password</h6><input type="password">
...
<style>
    ...
    #alexbizer{
        background-image: url('../assets/psikologi3.jpg');
    }
    button[type=button]
    {
        width:100%;
    ...
    .card-body a{
        text-decoration: none; margin-top: 5%; text-align: left;
    }
</style>