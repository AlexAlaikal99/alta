<template>
  <div class="container py-4 py-xl-5">
        <div class="row row-cols-1 row-cols-md-2">
            <div class="col"><img class="rounded w-100 h-100 fit-cover" style="min-height: 300px;" src="../assets/alex.jpg"></div>
            <div class="col d-flex flex-column justify-content-center p-4">
                ...
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start mb-5">
                    ...
                    <div>
                        <h4>Status</h4>
                        <p>Pelajar 2018 SMKN 1 Pasuruan & Mahasiswa Fasilkom Universitas Jember</p>
                    </div>
                </div>
                <div class="text-center text-md-start d-flex flex-column align-items-center align-items-md-start">
                    ...
                    <div>
                        <h4>Medsos</h4>
                        <p>Instagram : @alex_alaikal99</p>
                        <p>github : Alex Alaikal</p>
                        <p>dribble : Alaikal</p>
                        <p>email : m.alaikalfatony1999@gmail.com</p>
                        <p>Linkedin : alex alaikal</p>
                        <p>Whatssapp : 085336689357</p>
                    </div>
                </div>
            </div>
        </div>
